...
url = 'http://rm_host:8088/ws/v1/cluster/info'
...
try:
    ...
    file = open("/media/RamDisk/rm_status.txt", "a").close()
    file = open("/media/RamDisk/rm_status.txt", "r")
    ...
    file = open("/media/RamDisk/rm_status.txt", "w")
